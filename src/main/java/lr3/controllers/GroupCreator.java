...
import lr3.models.GroupModel;

/**
 * This class is a controller for the group model.
 *
 ...
 */
public class GroupCreator extends AbstractGroupCreator<GroupModel> {

    public GroupCreator(int index) {

        GroupModel group = new GroupModel();
        group.head.lastName += " (Curator)";
        group.name = "Group " + index;
        group.listPlural = "students";
        for (int i = 0; i < gen_size(5, 8); i++) group.list.add((new StudentCreator(i + 1)).object);
        this.object = group;

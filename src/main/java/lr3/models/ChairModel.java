...
/**
 * This class is a model that contains information about a typical chair in the university.
 * It is based off of the {@code lr3.models.AbstractGroupModel}
 * class and and has no additional functionality, as it is not required by the task.
 *
 ...
 */
public class ChairModel extends AbstractGroupModel<GroupModel> {
}
